...
public class ReportGenerator {
	...
	public String relatorio(String format, String Name, String PROREF, String relatorio, String url2, String filepath)
	...
	public String relatorio2(String format, String Name, String relatorio, String url2, String filepath, String date1,
			String date2, String operario, String ativo, String sector, String dados)
			throws JRException, SQLException {
		HashMap hm = null;
		String fileName = null;
		...
		String jrxmlFileName = "c:/" + filepath + "/relatorios/jasperfiles/recursos_humanos/" + relatorio + ".jrxml";
		String jasperFileName = "c:/" + filepath + "/relatorios/jasperfiles/recursos_humanos/" + relatorio + ".jasper";
		String exportFileName = "c:/" + filepath + "/relatorios/" + fileName;
